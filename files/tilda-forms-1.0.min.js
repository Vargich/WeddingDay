...
var FORMS_API_FIELD = {
  ...
  t_formsApi__safeSetValue = function t(e, r, o) {
    var n,
      ...
      i = void 0 !== a && a;
    return (
      e && e.value !== r && ((e.value = r), i || t_formsApi__sendChange(e)), r
    );
  },
  ...
  t_formsApi__waitForFieldReadyState = function t(e) {
    return new Promise(function (t) {
      ...
      e.data.isAsync && !o
        ? e.element.addEventListener("inputReady", r, { once: !0 })
        : r();
    });
  },
  ...
  t_formsApi__isConditionalForm = function t(e) {
    return (
      e.classList.contains("t-conditional-form") ||
      e.querySelector(".t-conditional")
    );
  },
  t_formsApi__getTildaField = function t(e) {
    ...
    if (!o || !n || !a)
      throw new Error(
        "Please, set all the required data-attrs to initialize FormInput."
      );
    var i = function t() {
  ...
  t_formsApi__radioFieldMixin = function t(e) {
    return (
      (e.data.inputs = Array.from(
        e.element.querySelectorAll('[type="radio"]')
      )),
      (e.getValue = function () {
      ...
      (e.reset = function () {
        ...
        e.data.inputs.forEach(function (e, o) {
          ...
          e.data.ownVariantInput &&
            t_formsApi__sendReset(e.data.ownVariantInput);
      }),
      e
    );
  },
      ...
      (e.onFieldReady = function () {
        return t_formsApi__waitForFieldReadyState(e).then(function () {
          var t = e.element.querySelector(
              ".t-radio-ownanswer, .t-checkbox-ownanswer"
            ),
  ...
  t_formsApi__checkboxesMixin = function t(e) {
    return (
      (e.data.inputs = Array.from(
        e.element.querySelectorAll('[type="checkbox"]')
      )),
      (e.focus = function () {
  ...
  t_formsApi__getUploadWidgetField = function t(e) {
    ...
    return (
      ...
      (r.getValue = function () {
        ...
        return {
          value: Array.from(
            e.querySelectorAll('[name^="' + r.data.fieldName + '"]')
          )
            .map(function (t) {
  ...
  t_formsApi__getUploadCareField = function t(e) {
    try {
      ...
      return (
        ...
        (r.reset = function () {
          var t = r.data.widget;
          t_formsApi__safeSetValue(t.inputElement, "", { silent: !0 }),
            t.reloadInfo();
        }),
        r
      );
  ...
  t_formsApi__getContactMethodField = function t(e) {
    var r = t_formsApi__getTildaField(e),
      ...
      n = o[0],
      a = o[1];
    (r.data.isContactMethod = !0),
      (r.data.typeInputName = n),
      (r.data.idInputName = a);
    var i,
      s = Array.from(e.querySelectorAll(".t-contact-method__type")).map(
        function (t) {
    ...
    return (
      (r.getValue = function () {
        var t,
          o = t_formsApi__safeValue(
            e.querySelector(
              '[name="' + r.data.idInputName + '"]:not([disabled])'
            )
          ),
          n = s.find(function (t) {
      ...
      (r.focus = function () {
        var t,
          e = r.element
            .querySelector(
              ".t-contact-method__value-container > :not(.t-contact-method__hidden)"
            )
  ...
  t_formsApi__getRadioButtonsField = function t(e) {
    return t_formsApi__ownVariantMixin(
      t_formsApi__radioFieldMixin(t_formsApi__getTildaField(e))
    );
  },
  t_formsApi__getCheckboxesField = function t(e) {
    return t_formsApi__ownVariantMixin(
      t_formsApi__checkboxesMixin(t_formsApi__getTildaField(e))
    );
  },
  ...
  t_formsApi__getRangeField = function t(e) {
    try {
      var r = t_formsApi__getTildaField(e),
        o = r.element.querySelector(".t-range"),
        n = r.reset;
      return (
        (r.reset = function () {
          ...
          n.call.apply(n, [this].concat(e)),
            null == o || o.dispatchEvent(new CustomEvent("displayChanged"));
        }),
        r
      );
    } catch (a) {
  ...
  t_formsApi__getFieldConstructor = function t(e) {
    ...
    switch (r) {
      case FORMS_API_FIELD.VARIANTS:
        return o
          ? t_formsApi__getCheckboxesField(e)
          : t_formsApi__getRadioButtonsField(e);
      case FORMS_API_FIELD.IMAGE_VARIANTS:
        return o
          ? t_formsApi__getCheckboxImagesField(e)
          : t_formsApi__getRadioImagesField(e);
      ...
      case FORMS_API_FIELD.RANGE:
        return t_formsApi__getRangeField(e);
      default:
  ...
  t_formsApi__initTildaField = function t(e) {
    return new Promise(function (t, r) {
      ...
      return (
        n || r(new Error("Error while trying to initialize TildaField Api.")),
        n.onFieldReady().then(t)
      );
    });
  },
  t_formsApi__clearForm = function t(e) {
    try {
      return Promise.resolve(
        _catch$1(
          function () {
            if (!(e instanceof HTMLFormElement))
              throw new Error("Must be called on a form element");
            var t = e.closest(".t-rec"),
              r,
              o = Array.from(e.querySelectorAll(".t-input-group")).map(
                t_formsApi__initTildaField
              );
            return Promise.resolve(Promise.allSettled(o)).then(function (r) {
              var o, n;
              r
                .filter(function (t) {
                ...
                t_formsApi__isConditionalForm(e) &&
                  t.dispatchEvent(
                    new CustomEvent("sync-conditionals", {
                      detail: { shouldPreventSubmit: !1 },
                    })
                  );
            });
          },
...
var t_forms__updateAllVariables = function t(e) {
    try {
      var r = _catch(
        function () {
          var t = e.closest(".t-rec"),
            r = t_forms__getUsedVariables([t], { unique: !0 }),
            o;
          r.filter(t_forms__isSystemVariable).forEach(function (e) {
            return t_forms__updateSystemVariable(t, t, e);
          });
          var n,
            a = r
              .filter(function (t) {
              ...
              .map(function (e) {
                try {
                  var r = t_forms__findFormField(t, e.name);
                  return r
                    ? Promise.resolve(t_formsApi__initTildaField(r)).then(
                        function (r) {
                          return r
                            ? (t_forms__updateInputVariable(t, e, r),
                              Promise.resolve())
                            : Promise.resolve();
                        }
                      )
          ...
          return Promise.resolve(Promise.all(a)).then(function () {});
        },
        function (t) {
  ...
  t_forms__focusInput = function t(e) {
    try {
      if (!e) return Promise.resolve();
      var r = e.closest(".t-input-group");
      if (!r) return Promise.resolve();
      var o = _catch(
        function () {
          return Promise.resolve(t_formsApi__initTildaField(r)).then(function (
            t
          ) {
            t.focus();
          });
...
function t_forms__initForms() {
  ...
  Array.prototype.forEach.call(t, function (t) {
    ...
    if (!window.initForms[o]) {
      ...
      if (r && n)
        return (
          t_forms__onCachedPageAction(n, e),
          void t_forms__offInputsAutocomplete(n)
        );
      if (
  ...
  t &&
    ...
    t.closest(".tn-atom__form") ||
      ...
      (t.timerID = setTimeout(function () {
        t.classList.add("t-input-ownanswer_active"),
      ...
      document.addEventListener("keydown", function () {
        ...
        Array.prototype.forEach.call(e, function (t) {
          t.addEventListener("focus", function () {
            if ("keyboard" === r) {
              var e = t;
              (e.classList.contains("t-input_pvis") ||
                e.classList.contains("t-input-phonemask")) &&
                (e = e.parentElement),
...
function t_forms__removePlaceholder(t) {
  ...
  if ("INPUT" === r.tagName) {
    ...
    n &&
      a &&
      ((window.t_forms__inputData[a] = n), r.setAttribute("placeholder", ""));
  }
}
...
function t_forms__addPlaceholder(t) {
  ...
  i &&
    n &&
    (r.setAttribute("placeholder", i), (window.t_forms__inputData[n] = ""));
}
    ...
    if (o) {
      ...
      if (
        (o.classList.contains("t-form__inputsbox_inrow") ||
          (n = r.querySelectorAll(".t-input-block_width")),
        0 !== n.length)
      ) {
        (o.classList.contains("t-form__inputsbox_vertical-form") ||
          o.closest(".t706")) &&
        ...
        Array.prototype.forEach.call(n, function (t) {
          ...
          r &&
            ...
            o.classList.contains("t-form__inputsbox_inrow") ||
              t_forms__calculateFieldsWidthInJS(e, a);
        });
  ...
  return (
    Array.prototype.forEach.call(t, function (t) {
      ...
      for (
        ...
        !n.previousElementSibling.classList.contains(
...
function t_forms__calculateFieldsWidthInJS(t, e) {
  ...
  for (var n in o)
    if (t.classList.contains(o[n])) {
      ...
      a &&
        a.classList.contains("t-input-title") &&
        (a.style.width = (e - r * (n - 1)) / n + "px"),
        window.innerWidth < 480 &&
          (t && (t.style.width = "100%"), a && (a.style.width = "100%"));
    }
}
      ...
      if (
        ...
        if (
          ...
          var l,
            ...
            d;
          if (
            !n.querySelectorAll(".js-formaction-services").length &&
            1 !== u &&
            !c
          ) {
          ...
          if (n.querySelector(".g-recaptcha") && window.grecaptcha) {
            ...
            if (p) window.grecaptcha.reset(p);
              ...
              (p = window.grecaptcha.render(a + "recaptcha", w)),
                (n.tildaCaptchaClientId = p);
            }
...
(window.t_forms__lang = (
  ...
  (window.t_forms__fieldApi = t_formsApi__initTildaField),
  t_onReady(function () {
    ...
    t_forms__initForms(),
      t_forms__processGetParameters(),
      Array.from(
        document.querySelectorAll(
          '.t396__elem[data-elem-type="form"]:not(.zero-form-rendered)'
        )
      ).forEach(function (t) {
        return t.addEventListener("render", t_forms__processGetParameters);
      });
    var n = !!document.querySelector(".t706"),
      a = !!document.querySelector(".js-payment-systembox"),
      i = !!document.querySelector("input[name=tld_product]");
    if (n || a || i) {
      var s = "tilda-forms-payments-1.0";
      if (!document.head.querySelector('script[src*="' + s + '"]')) {
    ...
    var c = window.t_forms__lang;
    if ("RU" !== c && "EN" !== c) {
      var u = "tilda-forms-dict-1.0";
      if (!document.head.querySelector('script[src*="' + u + '"]')) {
    ...
    if (!0 !== window.isInitEventsCustomMask) {
      ...
      (t.type = "text/javascript"),
        (t.src =
          "https://static.tildacdn." +
          t_forms__getRootZone() +
          "/js/tilda-forms-custommask-1.0.min.js"),
    ...
    for (
      ...
      if (!s(c)) {
        var u = !!parseInt(c.getAttribute("data-tilda-req") || 0, 10),
          ...
          m,
          f,
          _ = c.getAttribute("data-tilda-rule-minlength") || 0,
        ...
        (w.obj = c),
          ...
          _ && (_ = parseInt(_, 10)),
          p && (p = parseInt(p, 10));
        var b = !v.length && !h.length,
          E = "checkbox" === g || "radio" === g,
          A = e.querySelectorAll('[name="' + y + '"]:checked').length,
          F = c.classList.contains("t-checkboxes__hiddeninput");
        if (F || "radio" === g) {
          var x = F ? "checkbox" : "radio",
            S = c.closest(".t-input-block"),
            C =
              S &&
              S.querySelector(
                ".t-input__own-answer-input, .t-" + x + "-ownanswer"
              );
          if (C && C.checked) {
        ...
        if ((((v.length && !E) || (E && A)) && (n = !1), u && (b || (E && !A))))
          ...
          switch (d) {
            ...
            case "url":
              (m =
                /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я\-0-9]{2,11}\/?$/gi),
                v.length &&
                  ((f = (f =
                    (f = v.split("//")) && f.length > 1 ? f[1] : f[0]).split(
                    "/"
                  )) &&
                  f.length &&
                  f[0]
                    ? (f = f[0]).match(m) || w.type.push("url")
                    : (f && !f[0]) || w.type.push("url"));
              break;
            case "phone":
              var L = c.getAttribute("data-tilda-mask"),
                I = "^[0-9()+-";
              L &&
                (-1 !== L.indexOf("*")
                  ? (I += "a-zёа-я")
                  : (-1 !== L.indexOf("a") && (I += "a-z"),
                    -1 !== L.indexOf("а") && (I += "а-яё"))),
                (I += "]+$"),
                (m = new RegExp(I, "gi")),
                ((h.length && !h.match(m)) ||
                  1 == (f = h.replace(/[^0-9]+/g, "")).indexOf("000") ||
                  (1 == f.indexOf("111") && "9" != f.substring(0, 1)) ||
                  (1 == f.indexOf("222") && "5" != f.substring(0, 1)) ||
                  1 == f.indexOf("333") ||
                  1 == f.indexOf("444") ||
                  (1 == f.indexOf("5555") && "0" != f.substring(0, 1)) ||
                  (1 == f.indexOf("666") && "0" != f.substring(0, 1)) ||
                  (1 == f.indexOf("8888") && "4" != f.substring(0, 1))) &&
                  w.type.push("phone");
              break;
            case "number":
              (m = /^[0-9]+$/gi),
                h.length > 0 && !h.match(m) && w.type.push("number");
              break;
            case "date":
              t_onFuncLoad("t_datepicker__readDateFromInput", function () {
                var t = t_datepicker__readDateFromInput(c);
                h.length > 0 &&
                  !window.t_datepicker__isDateValid(t) &&
                  w.type.push("date");
              });
              break;
            case "time":
              (m = /^[0-9]{2}[:\.][0-9]{2}$/gi), //! TODO: 00:00 - 23:59. Заменить на
            ...
            case "chosevalue":
              var j;
              "true" === c.getAttribute("data-option-selected") ||
                w.type.push("chosevalue");
              break;
            case "promocode":
              "y" !== a ||
                !h.length ||
          ...
          _ > 0 && v.length && v.length < _ && w.type.push("minlength"),
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
        ...
        for (var w = 0; w < e[_].type.length; w++) {
          ...
          (u = ""),
            (l = r.querySelector(".js-rule-error-" + v))
              ? (l.textContent && l.innerText) || !h || -1 !== d.indexOf(h)
                ? ((u = l.textContent || l.innerText),
                  -1 === d.indexOf(u) &&
                    (d = d + '<p class="t-form__errorbox-item">' + u + "</p>"))
                : (d = d + '<p class="t-form__errorbox-item">' + h + "</p>")
              : h &&
                -1 === d.indexOf(h) &&
                (d = d + '<p class="t-form__errorbox-item">' + h + "</p>"),
            i &&
              (!u &&
                t_forms__getMsg(v + "field") &&
                (u = t_forms__getMsg(v + "field")),
              !u && h && (u = h),
              u &&
                a &&
                ((c = a.querySelectorAll(".t-input-error")),
    ...
    if (d) {
      ...
      var g = m.querySelectorAll(".t-form__errorbox-item");
      if (
        ...
        if (y && y.length) {
          var b,
            ...
            F = A ? getComputedStyle(A).zIndex : 0,
            x;
    ...
    if (
      ...
      document.addEventListener || (C = "focusin"),
        t_removeEventListener(f, C, S),
        t_addEventListener(f, C, S, !0),
        t_removeEventListener(f, "change", S),
        t_addEventListener(f, "change", S, !0);
    }
  ...
  (window.tildaForm.showErrors = function (t, e, r) {
    ...
    for (
      ...
      if (d && d.obj) {
        ...
        var f = t_forms__getElement(m),
          _;
        if (f && f instanceof Element)
          t_forms__showInputErrors(o, f.closest(s), d);
    ...
    if (e)
      try {
        ...
        (window.tildaForm.tildamember = {}),
          ...
          window.mauser.phonecode &&
            window.mauser.phone &&
            ((window.tildaForm.tildamember.phone = window.mauser.phone),
            (window.tildaForm.tildamember.phonecode = window.mauser.phonecode)),
          window.mauser.token &&
  ...
  (window.tildaForm.closeSuccessPopup = function () {
    ...
    if (o) {
      t_removeClass(document.body, "t-body_success-popup-showed"),
        ...
        t_fadeOut(o),
        o.classList.contains("t-form-success-popup_new") &&
    ...
    function _() {
      return {
        ...
        linkButton: {
          ...
          content:
            o || t_forms__getMsg(s ? "success_btn_redirect" : "success_btn"),
          show: s,
        },
        closeButton: {
        ...
        infoText: {
          ...
          content: t_forms__getMsg(
            l ? "success_info_redirect_error" : "success_info"
          ),
          show: s,
        },
        infoDigit: {
          element: document.getElementById(
            "tildaformsuccesspopupinfodigit-new"
          ),
          content: l ? "" : "3",
          show: s,
        },
  ...
  (window.tildaForm.successEnd = function (t, e, r) {
    ...
    var n = o.closest(".t-popup"),
      a = o.closest(".t1093"),
      i = t_forms__isNewSuccessBox(o) && n && !a,
      s = "y" === o.getAttribute("data-success-popup");
    function l() {
      t_forms__handleSuccess(o, { successCallback: r, successUrl: e }),
        ...
        (t_forms__isNewSuccessBox(o) || s) && window.t_forms__clearForm(o);
    }
    function c() {
    ...
    if (i) {
      var u = 320;
      return t_forms__processFormsInPopup(n, o), void setTimeout(c, u);
    }
    c();
  }),
  ...
  (window.tildaForm.send = function (
    ...
    if (
      ...
      return (
        ...
        secondFormTypeXhr.setRequestHeader(
          "Accept",
        ...
        (secondFormTypeXhr.onreadystatechange = function () {
          if (4 === secondFormTypeXhr.readyState)
            if (
              secondFormTypeXhr.status >= 200 &&
              secondFormTypeXhr.status < 400
            ) {
              ...
              if (
                ...
                (allError = msgContainers.allError),
                !secondFormTypeXhr ||
                  (0 == secondFormTypeXhr.status && tsDelta < 100))
              )
                Array.prototype.forEach.call(allError, function (t) {
                  t.innerHTML =
          ...
          if (4 === formAjaxXhr.readyState)
            if (formAjaxXhr.status >= 200 && formAjaxXhr.status < 400) {
              ...
              "function" == typeof window.Tilda.sendEventToStatistics
                ...
                : window.mainMetrika > "" &&
                  window[window.mainMetrika] &&
                  window[window.mainMetrika].hit(a, {
                    title: i,
                    referer: window.location.href,
                  }),
                t_triggerEvent(form, "tildaform:aftersuccess"),
...
function t_forms__showEmptyFormError(t) {
  ...
  e.forEach(function (t) {
    ...
    t_forms__addMoveToInputWithErrorClickHandler(
      t.querySelector(".t-input-group"),
      e[0]
    );
}
...
function t_forms__showFormErrors(t, e, r) {
  e.type.forEach(function (o) {
    var n = t.querySelectorAll(".js-rule-error-" + o),
      ...
      s;
    (n.length ? n : t.querySelectorAll(".js-rule-error-all")).forEach(function (
      t
    ) {
  ...
  return {
    add: function e(r, o, n) {
      ...
      !t[r] &&
        o &&
        a &&
        (t_forms__addMoveToInputWithErrorClickHandler(o, n), (t[r] = o));
    },
  };
}
...
function t_forms__getMsg(t) {
  ...
  return (
    (e.EN = {
      ...
      cached_page_popup_text:
        "To fill out and submit the form, go to the original page",
    ...
    (e.RU = {
      ...
      cached_page_popup_title:
        "Отправка формы доступна на оригинальной странице",
      cached_page_popup_text:
        "Чтобы заполнить и отправить форму перейдите на оригинальную страницу",
      cached_page_popup_btn: "Перейти",
    }),
    "function" == typeof t_forms__getDict &&
      "RU" !== r &&
      "EN" !== r &&
      (e = window.t_forms__getDict()),
    e[r] ? e[r][t] : e.EN[t]
  );
}
function checkVerifyTildaCaptcha(t) {
  ...
  if (-1 !== e.origin.indexOf(window.tildaForm.endpoint)) {
    ...
    if ("closeiframe" == e.data)
      return o && t_removeEl(o), void (r && t_removeEl(r));
    var n = e.data;
    if (
      ("object" == typeof n &&
        ((n = JSON.stringify(n)),
...
function t_forms__onSuccess(t) {
  ...
  var E = document.querySelector(".t-tildalabel"),
    A = t_forms__isNewSuccessBox(e);
  if (m > window.scrollY || v - u < _ - 100)
    A || n.classList.add(g),
      _ > v &&
        E &&
        setTimeout(function () {
...
function t_forms__handleRedirect(t, e, r) {
  ...
  if (t_forms__isNewSuccessBox(t)) {
    ...
    function d(t) {
      ...
      t.preventDefault(),
        clearTimeout(c),
        m(t.currentTarget.getAttribute("href"));
    }
    function m(t) {
...
function t_forms__isSystemVariable(t) {
  return (
    "tilda" === t.domain &&
    Object.values(t_forms__getSystemVariables()).includes(t.name)
  );
}
function t_forms__updateVariables(t, e, r) {
  var o = t.querySelectorAll(
    '.t-variable-placeholder[data-variable="' +
      e.name +
...
function t_forms__updateInputVariable(t, e, r) {
  var o = r.getValue,
    ...
    i = o().value;
  if (
    (n.ownVariantTitle && i && (i = i.replace(n.ownVariantTitle + ": ", "")),
    n.isContactMethod)
  ) {
    var s = i[e.name];
...
function t_forms__parseVariables(t) {
  var e = t_forms__replaceVariablesWithPlaceholders(t),
    r;
  return e.length
    ? t_forms__bindFormVariablesToPlaceholders(t.closest(".t-rec"), e)
    : Promise.resolve();
}
function t_forms__findFormField(t, e) {
  ...
  return (
    r ||
    Array.from(
      t.querySelectorAll('.t-input-group[data-field-name*="' + e + '"]')
    ).find(function (t) {
...
function t_forms__clearFormData(t) {
  "undefined" != typeof jQuery &&
    jQuery(t).data("tildaformresult", { tranId: "0", orderId: "0" }),
    (t.tildaTranId = "0"),
    (t.tildaOrderId = "0");
}
...
function t_forms__handleSuccess(form, options) {
  var _ref2 = options || {},
    ...
    successCallback =
      void 0 === _ref2$successCallback ? "" : _ref2$successCallback,
    callback = (successCallback || "").replace("window.", "");
  if (callback && "function" == typeof window[callback])
    "undefined" != typeof jQuery
      ? eval(callback + "(jQuery(form))")
      : eval(callback + "(form)");
  else if (successUrl) {
...
function t_forms__isNewSuccessBox(t) {
  return (
    !!t &&
    !t_forms__isQuiz(t) &&
    !["t396", "t447", "t651", "t653", "t706", "t708", "t945", "t1122"].some(
      function (e) {
        return t.closest("." + e);
      }
    )
...
function t_forms__getFormData(t) {
  ...
  try {
    ...
    else if (t.closest(".t706__orderform"))
      return { status: "invalid", data: "", contentType: "" };
    return (
      window.tildaForm.tildamember &&
        Object.keys(window.tildaForm.tildamember).length > 0 &&
        l.push({
...
function t_forms__shouldEnableFormAsJSON() {
  try {
    var t;
    return (
      "true" === new URLSearchParams(window.location.search).get("sendjson")
    );
  } catch (e) {
    return !1;
  }
  ...
  for (
    ...
    if (
      !(
        !r[a].name ||
        r[a].disabled ||
        ["file", "reset", "submit", "button"].indexOf(r[a].type) > -1 ||
        n(r[a])
      )
    )
...
function t_forms__processFormsInPopup(t, e) {
  ...
  var n = e.closest(".t-rec"),
    a = n.getAttribute("data-record-type"),
    i;
  "121" === a &&
    (a =
      t.querySelector(".t-popup__container").getAttribute("data-popup-type") ||
      "121");
  var s = "t" + a + "_closePopup",
    l = n.id.replace("rec", ""),
    c = window[s];
...
function t_forms__trapFocus(t) {
  ...
  document.addEventListener("keydown", function (t) {
    if (document.body.classList.contains("t-body_popupshowed")) {
      ...
      (e || (e && t.shiftKey)) &&
        (t.shiftKey &&
          document.activeElement.classList.contains("t-popup_show") &&
          o.focus(),
        "Tab" !== t.key ||
          t.shiftKey ||
...
function t_forms__processGetParameters(t) {
  if (
    (void 0 === t && (t = {}),
    window.URLSearchParams && "published" === t_forms__getTildaMode())
  ) {
    ...
    if (null != e && e.size) {
      var r,
        ...
        n = [
          ...
          ".t-img-select",
          ".t-range",
          ".t-checkboxes__hiddeninput",
          ".t-img-select__hiddeninput",
          '[type="hidden"]',
        ];
      o ||
        (n = n.map(function (t) {
          return ".js-form-proccess " + t;
        }));
      var a = o || document,
        i = Array.from(a.querySelectorAll(n)),
        s;
      if (i.length)
        new Set(
          i
          ...
          var r = e.get("form-setter-" + t);
          if (r) {
            var o = i.filter(function (e) {
              return e.getAttribute("name") === t;
            });
            (o = t_forms__includeCheckboxesForInputList(o)).forEach(function (
              t
            ) {
              return t_forms__setGetParameterToField(t, r);
            });
          }
        });
    }
...
function t_forms__includeCheckboxesForInputList(t) {
  return t.reduce(function (t, e) {
    if (
      e.classList.contains("t-checkboxes__hiddeninput") ||
      e.classList.contains("t-img-select__hiddeninput")
    ) {
      var r = e.closest(".t-input-block"),
        o = Array.from(
          (null == r
            ? void 0
            : r.querySelectorAll(".t-checkbox, .t-img-select")) || []
        );
      t.push.apply(t, o);
    } else t.push(e);
    return t;
...
function t_forms__setGetParameterToField(t, e) {
  if (!["tel", "number", "range"].includes(t.type) || !isNaN(e)) {
    var r = 500;
    ["checkbox", "radio"].includes(t.type)
      ? l(function () {
          var n,
            s = e.split(","),
            l = (null == t || null == (n = t.value) ? void 0 : n.trim()) || "";
          s.includes(l) &&
            ((t.checked = !0),
            "checkbox" === t.type && o(),
            t.classList.contains("t-rate") && a(),
            "radio" === t.type &&
              t.closest(".t-contact-method__types-container") &&
              i(r));
        })
      : "select-one" === t.type
      ? n()
      : ((t.value = e),
        t.classList.contains("t-range") && i(),
        "tel" === t.type && s()),
      l(i, !1);
  }
  function o() {
    var e = t.closest(".tn-elem .t-checkbox__control"),
    ...
    if (e)
      ...
      var n = t.closest(".t-checkbox__control, .t-img-select__control");
      n && o && (t.checked = !1), n && n.dispatchEvent(new Event("click"));
    }
  }
  function n() {
    var r,
      o = Array.from(t.options).find(function (t) {
        return t.value.trim() === e;
      });
    o && (o.selected = !0);
  }
  function a() {
    var e;
    null == (e = t.closest(".t-rate__wrapper")) ||
      e.classList.add("t-rate__wrapper_active");
  }
  function i(e) {
    var r = function e() {
      return t.dispatchEvent(new Event("change"));
    };
    e ? setTimeout(r, e) : r();
  }
  function s() {
    var e = t.getAttribute("data-phonemask-lid");
    e && (e = "input_" + e),
      e || (e = t.id),
      e &&
        setTimeout(function () {
          var t = document.getElementById(e);
          null == t || t.dispatchEvent(new Event("input"));
        }, r);
  }
  function l(t, e) {
    void 0 === e && (e = !0);
    var r = c();
    (e || r) &&
      (r && "y" !== r.getAttribute("data-init-calc")
        ? r.addEventListener("inputReady", t)
        : t());
  }
  function c() {
    var e = t.closest(".t-form");
    if (!e) return null;
    var r = Array.from(e.querySelectorAll("[data-calc-expr]"));
    if (!r.length) return null;
    var o = r.find(function (e) {
      return e.getAttribute("data-calc-expr").includes(t.name);
    });
    return (null == o ? void 0 : o.closest(".t-input-group")) || null;
  }
}
function t_forms__getTildaMode() {
  if (void 0 !== window.tildamode) return window.tildamode;
  var t = document.getElementById("allrecords");
  return t
    ? ((window.tildamode = t.getAttribute("data-tilda-mode") || "published"),
      window.tildamode)
    : "notdefined";
}
