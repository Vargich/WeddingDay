function t396__parseGlobalStyleCSSVar(t) {
  try {
    var e,
      i = /var\((--uc-([^-]+)-([^-]+)-([^,]+)),\s?(.*)\)/.exec(t);
    if (!i) return;
    ...
    return {
      parent: { id: l, type: n },
      fallback: window.getComputedStyle(document.body).getPropertyValue(o) || d,
      field: a,
    };
  } catch (u) {
    console.error("Error trying to parse CSS Variable");
  }
}
function t396__hex2rgba(t, e) {
  if (!t) return !1;
  var i = t396__parseGlobalStyleCSSVar(t);
  i && (t = i.fallback);
  var r = t.replace(/#/, "");
  if (3 === r.length) {
    var o = r[0],
  ...
  var l = parseInt(t.substring(1), 16),
    d,
    _,
    s;
  return [(16711680 & l) >> 16, (65280 & l) >> 8, 255 & l, parseFloat(e)];
}
...
function t396__setOverflowToAllRecords() {
  ...
  if (t) {
    ...
    t.classList.remove(
      ...
      t.classList.add(
        i ? "t-records__overflow-clip" : "t-records__overflow-hidden"
      );
  }
}
  ...
  return t.length
    ? t
        .map(function (t) {
          return {
            record: t.closest(
              ".r:not(.t397__off):not(.t395__off):not(.t400__off)"
            ),
            artboard: t,
          };
        })
...
function t396_init(t) {
  ...
  if (r) {
    ...
    void 0 === window.tn.isEditMode && (window.tn.isEditMode = l),
      t396_switchResolution(t, n);
    var d = "window" === t396_ab__getFieldValue(r, "upscale"),
      _ = t396__setGlobalScaleVariables(t, n, d);
    if (
      (t396__setScaleFactorForElements(t, _),
      t396_updateTNobj(t),
      t396_artboard_build(o, t),
      window.addEventListener("load", function () {
        t396_allelems__renderView(r),
          t396_allgroups__renderView(r),
          t396__initializeArtboardOverflow(a, r);
      }),
      ...
      var s = new MutationObserver(function (e) {
        e.forEach(function (e) {
          "attributes" === e.type &&
            ...
            (t396_doResize(t, !0), s.disconnect());
        });
      });
      s.observe(document.body, { attributes: !0 });
    }
    ...
    var u = "hug" === r.getAttribute("data-artboard-heightmode");
    if (u) {
      ...
      c(),
        setInterval(c, 3e3),
        document.fonts && document.fonts.ready.then(c),
        r.querySelectorAll("img").forEach(function (t) {
          t.onload = c;
        }),
        new MutationObserver(c).observe(r, {
          subtree: !0,
          characterData: !0,
...
(window.t396__isMobile =
  ...
  (window.t396__isInAppBrowser =
    /WebView|(iPhone|iPod|iPad)(?!.*Safari)/gi.test(navigator.userAgent)),
  (window.t396__isFacebookMessengerInApp =
    /FBAN|FBAV/gi.test(navigator.userAgent) && window.t396__isInAppBrowser),
  (window.t396__isInstagramInApp =
    /\bInstagram/gi.test(navigator.userAgent) && window.t396__isInAppBrowser),
...
function t396__handleResizeOpenedPopup() {
...
function t396__initPopupResize() {
...
function t396_ab__getWindowWidth(t) {
  return t396__isInPopup(t)
    ? document.documentElement.clientWidth
    : t396__getWindowDimensions().width;
  var e, i;
}
...
function t396__getWindowDimensions(t) {
  var e,
    ...
    o =
      ...
      !window.tn.window_height ||
      !window.tn.window_width_css,
    n;
  return (
    (r || o) && t396__updateWindowDimensions(),
    {
...
function t396__updateWindowDimensions() {
  (window.tn.window_width = t396__getTNWindowWidth()),
    (window.tn.window_height = t396__getTNWindowHeight()),
    (window.tn.window_width_css = t396__getCSSWindowWidth());
}
function t396__removeInlineHeight(t) {
  "1.0" !== window.TN_SCALE_INITIAL_VER &&
...
function t396__clearInitialScaleStyles() {
  if ("1.0" === window.TN_SCALE_INITIAL_VER) {
    ...
    t396__getZeroBlocks().forEach(function (e) {
      var i = e.artboard;
      i &&
        (i.style.removeProperty("--initial-scale-height"),
        t(i),
        t(i.querySelector(".t396__carrier")),
        t(i.querySelector(".t396__filter")));
    });
  }
}
function t396__globalInit() {
  window.tn || t396_initTNobj__createDefault(),
    t396__isAllZeroBlocksRendered(function () {
      t396__applyFixesForAllElements(),
        t396__initializeAnchorLinkOverflowFix(),
        t396__initPopupResize(),
    ...
    function () {
      ...
      t396__getZeroBlocks().forEach(function (t) {
        var e = t.artboard,
          i = t.record;
        if (
          (e.classList.add("t396_resizechange"),
          window.t396__isMobile || window.t396__isTouchDevice)
        ) {
          if (o) {
            if (!i) return;
            if (!t396_isBlockVisible(i)) return;
            t396_doResize(i.id.replace("rec", "")),
              e.classList.remove("t396_resizechange");
          }
        } else {
          if (!i) return;
          if (!t396_isBlockVisible(i)) return;
...
function t396__setGlobalScaleVariables(t, e, i) {
  var r = 1,
    ...
    n = o ? o.querySelector(".t396__artboard") : null;
  if (!n) return 1;
  var a = t396_ab__getWindowWidth(n),
    l = i ? parseFloat((a / e).toFixed(3)) : 1,
    d = "ab" + t;
  (window.tn[d].scaleFactor = l), (window.tn_scale_factor = l);
  var _ = document.getElementById("rec" + t);
  return (
    _ && !window.tn.isEditMode && _.style.setProperty("--zoom", l.toString()), l
  );
}
...
function t396_doResize(t, e) {
  ...
  if (
    (t396_removeElementFromDOM(
      r ? r.querySelector(".t396__scale-style") : null
    ),
    i)
  ) {
  ...
  var _ = r ? r.querySelector(".t396__artboard") : null,
    ...
    u = t396__setGlobalScaleVariables(t, n, s);
  t396__setScaleFactorForElements(t, u),
    t396_updateTNobj(t),
    t396_ab__renderView(_);
  var c = o ? o.getAttribute("data-tilda-mode") : "";
  s &&
    "edit" !== c &&
    t_onFuncLoad("t396_scaleBlock", function () {
      t396_scaleBlock(t);
  ...
  var f = "hug" === _.getAttribute("data-artboard-heightmode");
  _ &&
    !f &&
    (window.t396__isMobile ||
      t396__removeInlineHeight([
        _,
        _.querySelector(".t396__carrier"),
        _.querySelector(".t396__filter"),
      ]));
}
...
function t396__getAutoHeight(t) {
  var e,
    i = t.classList.contains("t396__artboard-flex"),
    r = Array.from(t.querySelectorAll(":scope > .tn-group, :scope > .tn-elem")),
    o = r.some(function (t) {
      return "gallery" === t.getAttribute("data-elem-type");
    }),
    n = t.style.height;
  if (i && !o && n) {
    var a = t.style.height;
    (t.style.height = "auto"), (e = t.offsetHeight), (t.style.height = a);
  } else
    e = r.reduce(function (e, i) {
      ...
      var a = 0;
      "gallery" === i.getAttribute("data-elem-type") &&
        (a = t396__autoHeight__getAdditionalOffsetForGallery(i));
      var l = i.offsetTop + i.offsetHeight + a,
        d,
        _,
        s;
      "window" !== t396_ab__getFieldValue(t, "upscale") ||
        window.tn.isEditMode ||
        (l *= t396__getCurrentScaleFactor(
          t.getAttribute("data-artboard-recid")
        ));
      return l > e ? l : e;
    }, -1 / 0);
  return e === -1 / 0 ? 0 : e;
}
function t396__autoHeight__getAdditionalOffsetForGallery(t) {
  var e = 0,
    i = t.querySelector(".t-slds__title"),
    r = "none" !== t396_core__getFieldValue(t, "slds_dotscontrols"),
    o = "under" === t396_core__getFieldValue(t, "slds_arrowcontrols");
  if (i || r || o) {
    var n = t.querySelector(".t-slds__title"),
      a = n ? n.offsetHeight : 0,
      l = t.querySelector(".t-slds__caption.t-slds__caption-active"),
      d = getComputedStyle(l),
      _;
    e += parseInt(d.marginTop, 10) + a;
  }
  return i || (!r && !o) || (e -= 20), e;
}
...
function t396_detectResolution(t) {
  if (!t) return null;
  var e,
    i = t396__getWindowDimensions().cssWidth,
    r = "ab" + t,
    o;
  return (
    window.tn[r].screens.forEach(function (t) {
      i >= t && (o = t);
    }),
    void 0 === o && (o = window.tn[r].screens[0]),
    o
  );
}
function t396_initTNobj__createDefault() {
  (window.tn = {}),
    (window.tn.ab_fields = [
      "height",
      "width",
...
function t396_initTNobj(t, e) {
  e &&
    (window.tn || t396_initTNobj__createDefault(), t396_setScreensTNobj(t, e));
}
...
function t396_updateTNobj(t) {
  for (
    var e,
      i = t396__getWindowDimensions().width,
      r = "ab" + t,
      o = window.tn[r].screens.slice().reverse(),
      n = 0;
    n < o.length;
    n++
  )
    window.tn[r].curResolution === o[n] &&
      ((window.tn[r].canvas_min_width = o[n]),
      (window.tn[r].canvas_max_width = 0 === n ? i : o[n - 1]));
  var a = "allrecords" === window.zero_window_width_hook;
  window.tn[r].grid_width = window.tn[r].canvas_min_width;
  var l = (i - window.tn[r].grid_width) / 2;
  window.tn[r].grid_offset_left = l < 0 && a ? 0 : l;
}
...
function t396_artboard_build(t, e) {
  var i = document.getElementById("rec" + e),
    r = i ? i.querySelector(".t396__artboard") : null;
  if (r) {
    t396_ab__renderView(r), t396_allgroups__renderView(r);
    var o = r.querySelectorAll(".tn-elem");
    Array.prototype.forEach.call(o, function (t) {
      ...
      switch (t.getAttribute("data-elem-type")) {
        ...
        case "form":
          ...
          break;
        case "gallery":
          t396_addGallery(r, t, e);
          break;
        case "vector":
          t396_addVector(r, t);
      }
    }),
      r.classList.remove("rendering"),
      r.classList.add("rendered"),
      r.dispatchEvent(
        new Event("artBoardRendered", { bubbles: !0, cancelable: !0 })
      );
    var n = r.getAttribute("data-artboard-ovrflw");
    if (
      (["visible", "visibleX"].includes(n) && t396__setOverflowToAllRecords(),
      "auto" === n)
    ) {
      var a = Math.abs(r.offsetHeight - r.clientHeight);
      0 !== a && (r.style.paddingBottom = a + "px");
    }
  ...
  if (t) {
    ...
    if (
      ...
      switch (t396_ab__getFieldValue(t, "valign")) {
        ...
        case "center":
          c = u
            ? parseFloat(((a - u) / 2).toFixed(1))
            : parseFloat(((a - n) / 2).toFixed(1));
          break;
        case "bottom":
          c = u
            ? parseFloat((a - u).toFixed(1))
            : parseFloat((a - n).toFixed(1));
          break;
        case "stretch":
          (c = 0), (n = a);
      }
    ...
    var w = t.querySelector(".t396__filter"),
      g = t.querySelector(".t396__carrier"),
      p;
    if (
      ((r = t396_ab__getFieldValue(t, "height_vh")),
      (r = parseFloat(r)),
...
function t396__setScaleFactorForElements(t, e) {
  var i = document.getElementById("rec" + t),
    r = i ? i.querySelector(".t396__artboard") : null;
  if (r) {
    var o = r.querySelectorAll(".t396__elem, .tn-group");
    Array.prototype.forEach.call(o, function (t) {
      t.scaleFactor = e;
    });
  }
...
function t396_addText(t, e) {
  ...
  if (i) {
    var r =
      "top,left,width,height,container,axisx,axisy,widthunits,leftunits,topunits";
...
function t396_addForm(t, e, i) {
  ...
  if (r) {
    var o = "width,top,left,",
      n;
    (o += "inputs,container,axisx,axisy,widthunits,leftunits,topunits"),
...
function t396_elem__getFieldValue(t, e) {
  ...
  var r = i.closest(".t396__artboard"),
    ...
    a;
  void 0 === window.tn[n] &&
    (t396_initTNobj(o, r), t396_switchResolution(o, t396_detectResolution(o)));
...
function t396_elem__renderViewOneField(t, e) {
  ...
  if (i) {
    var r = document.getElementById("allrecords"),
      ...
      a =
        "window" ===
        t396_ab__getFieldValue(i.closest(".t396__artboard"), "upscale");
      ...
      switch (e) {
        case "left":
          (l = t396_elem__convertPosition__Local__toAbsolute(i, e, l)),
            (l = s
              ? t396__zoomifyValue(i, l)
              : parseFloat(l).toFixed(1) + "px"),
            (i.style.left = l);
          break;
        case "top":
          (l = t396_elem__convertPosition__Local__toAbsolute(i, e, l)),
        ...
        case "width":
          ...
          if (
            "text" === d &&
            "autowidth" === t396_elem__getFieldValue(i, "textfit")
          )
            return void (i.style.width = "auto");
          if (_.includes(u)) return void (i.style.width = "");
          switch (
            ((l = t396_elem__getWidth(i, l)),
            (i.style.width = parseFloat(l).toFixed(1) + "px"),
            d)
          ) {
            case "tooltip":
        ...
        case "height":
          d = i.getAttribute("data-elem-type");
          var f = t396_elem__getFieldValue(i, "heightmode"),
            w = t396_elem__getFieldValue(i, "textfit");
          if ("text" === d && (["autowidth", "autoheight"].includes(w) || !w))
            return void (i.style.height = "auto");
          if (_.includes(f) && "tooltip" !== d)
            return void (i.style.height = "");
          if ("tooltip" === d) return;
          ...
          break;
        case "container":
          t396_elem__renderViewOneField(i, "left"),
            t396_elem__renderViewOneField(i, "top");
          break;
        case "inputs":
          var g = i.querySelector(".tn-atom__inputs-textarea");
          l = g ? g.value : "";
          try {
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  ...
  var o = r.closest(".t396__artboard"),
    ...
    f = !u && d && c,
    w = !u && d && !c,
    g = t396_elem__getFieldValue(r, "axisy"),
    p = t396_elem__getFieldValue(r, "axisx"),
    h = t396_elem__getFieldValue(r, "container"),
    m =
      r.classList.contains("tn-group") &&
      "physical" === t396_group__getFieldValue(r, "type"),
  ...
  var y = parseInt(i),
    ...
    E,
    k,
    z = t396__getCurrentScaleFactor(n);
  switch (e) {
    case "left":
      var I,
      ...
      if (
        ...
        (V = "grid" === h ? window.tn[a].grid_width : B),
        "%" === t396_elem__getFieldValue(r, "leftunits") &&
          (y = t396_roundFloat((V * y) / 100)),
        v)
      ) {
        var O = parseInt(t396_group__getFieldValue(b, "left"), 10),
          T;
        "%" === t396_group__getFieldValue(b, "leftunits") &&
          (O = t396_roundFloat((V * O) / 100)),
          (y -= O);
        break;
      }
      !u && d ? "grid" === h && c && (y *= z) : (y = A + y),
        "center" === p &&
          ((x = t396_elem__getWidth(r)),
          f && "window" !== F && ((V *= z), (x *= z)),
          (y = V / 2 - x / 2 + y)),
        "right" === p &&
          ((x = t396_elem__getWidth(r)),
        ...
        f &&
          "window" !== F &&
          (y += ((x = t396_elem__getWidth(r)) * z - x) / 2);
      break;
    case "top":
      var R = r.closest(".t396__artboard"),
      ...
      if (
        ((F = "grid" === h ? "grid" : "window"),
        (S = "grid" === h ? parseFloat(q) : 0),
        (k = "grid" === h ? parseFloat(W) : parseFloat(H)),
        "%" === t396_elem__getFieldValue(r, "topunits") && (y = k * (y / 100)),
        v)
      ) {
        var M = parseInt(t396_group__getFieldValue(b, "top"), 10),
          N;
        "%" === t396_group__getFieldValue(b, "topunits") &&
          (M = t396_roundFloat((k * M) / 100)),
          (y -= M);
        break;
      }
      f && "window" !== F && (y *= z),
        w && "window" !== F && (S = "stretch" === l ? 0 : S / z),
        (y = S + y);
      var D = t396_ab__getFieldValue(R, "height_vh"),
        j = t396_ab__getFieldValue(R, "height"),
        G = t396_ab__getHeight(R),
        Z;
      if (
        (d && !u && D && (Z = parseInt(j, 10) * z),
        "center" === g &&
          ((E = C(r)),
          f &&
            "window" !== F &&
          ...
          u ||
            ...
            "window" === F ||
            "stretch" !== l ||
            ((k = Z ? (Z > G ? Z : G) : R.clientHeight), (k /= z)),
          (y = k / 2 - E / 2 + y)),
        "bottom" === g &&
          ((E = C(r)),
          f &&
  ...
  if (
    ...
    (i =
      a === l
        ...
        : t.getAttribute("data-artboard-" + e + "-res-" + a))
  )
...
function t396_core__getFieldValue(t, e) {
  return t.classList.contains("t396__elem")
    ? t396_elem__getFieldValue(t, e)
    : t396_group__getFieldValue(t, e);
}
...
function t396_elem__getHeight(t, e) {
  ...
  if ("text" === o) {
    var w = i.querySelector(".tn-atom");
    w && (w.style.lineHeight = "");
  }
...
function t396__getBlockEditorWidth() {
  ...
  var t,
    e = window
      ...
      .getPropertyValue("--page-view-width");
  ...
  e.read(function () {
    Array.prototype.forEach.call(t, function (t) {
      ...
      if (
        ...
        var r = getComputedStyle(t),
          ...
          n = t.getAttribute("data-animate-style");
        if (o && !n) {
          var a = t.querySelector(".tn-atom"),
            l = a ? window.getComputedStyle(a).transform : "none";
          "matrix(1, 0, 0, 1, 0, 0)" === l && (l = "none"),
            "none" !== l && i.push({ element: t, atom: a, atomTransform: l });
        }
      }
    });
  }),
    e.write(function () {
      i.forEach(function (t) {
        (t.atom.style.transform = "none"),
          (t.element.style.transform = t.atomTransform);
      });
    });
}
function t396__fixElementsLineHeights(t) {
  ...
  e.read(function () {
    ...
    e.read(function () {
      i.forEach(function (t) {
        t.computedLineHeight = parseFloat(
          window.getComputedStyle(t.atom).lineHeight
        );
      });
    }),
    e.write(function () {
        ...
        if ("text" === e || "button" === e) {
          ...
          if (i) {
            var o = t396_elem_findFirstLevelParentGroup(t),
              n = { element: t, atom: i, zoom: 1, elementType: e };
            if (
              (o && o.style.zoom && (n.zoom = parseFloat(o.style.zoom)),
              1 !== n.zoom)
            ) {
              var a = t396_elem__getFieldValue(t, "fontsize");
              a && (n.fieldFontSize = parseFloat(a)), r.push(n);
            }
          }
        }
      });
      ...
      i.read(function () {
        r.forEach(function (t) {
          var e = parseFloat(window.getComputedStyle(t.atom).fontSize),
            i = t.fieldFontSize && Math.abs(t.fieldFontSize - e) <= 0.01,
            r = Number.isInteger(e);
          t.correctFontSize =
            i || r
              ? "calc(" + e + "px * var(--zoom, 1))"
              : "calc(" + e + "px * var(--zoom, 1) * var(--zoom, 1))";
        });
      }),
      i.write(function () {
        r.forEach(function (t) {
          t.atom.style.fontSize = t.correctFontSize;
        });
      });
  }
}
...
function t396__zoomifyValue(t, e) {
  var i,
    ...
    o;
  return t396__isInsideGroupWithZoom(t)
    ? r
    : "calc(" + r + " * var(--zoom, 1))";
}
function t396__isInPopup(t) {
  ...
  var e = t.getAttribute("data-artboard-recid"),
    ...
    r;
  return document
    .getElementById("rec" + e)
    .parentNode.classList.contains("t-popup__container");
}
...
function t396__shouldUseVisualViewportHeight() {
  return (
    "visualViewport" in window && window.t396__isMobile && window.t396__isSafari
  );
}
...
function t396__initializeArtboardOverflow(t, e) {
  if (e && t) {
    var i = window.getComputedStyle(e).getPropertyValue("overflow");
    if ("auto" === i) {
      var r = t.getAttribute("data-tilda-lazy");
      ("y" !== window.lazy && "yes" !== r) ||
        t_onFuncLoad("t_lazyload_update", function () {
          e.addEventListener(
            "scroll",
            t_throttle(window.t_lazyload_update, 500)
          );
        });
    }
...
function t396__initializeAnchorLinkOverflowFix() {
  var t = document.querySelectorAll('[data-artboard-ovrflw="visible"]');
  t.length &&
